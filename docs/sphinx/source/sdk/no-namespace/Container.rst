...
.. php:class:: Container
    ...
    .. php:method:: create($name, $exists = "overwrite")
    ...
    .. php:method:: upload($path, $name = null, $exists = 'fail')
    ...
    .. php:method:: path_from_item($item = null)
        ...
        :type $item: null
        :param $item: The items whose path needs to be retrieved.
    ...
    .. php:method:: is_mirrored()
        ...
        :returns: The is mirrored flag of this item.
