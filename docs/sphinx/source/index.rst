...
.. note:: You need to create a session in order to perform folder operations.
  ...
  - :php:meth:`Copy Folder <Item::copy_to>`
    ...
    ::
      ...
      $newItem = $item->copy_to($destinationPath, Exists::OVERWRITE);
  ...
  - :php:meth:`Move Folder <Item::move_to>`
    ...
    ::
      ...
      $newItem = $item->move_to($destinationPath, Exists::OVERWRITE);
  ...
  - :php:meth:`Create Sub Folder <Item::create>`
  ...
  - :php:meth:`Upload File <Item::upload>`
